...
var helpers = module.exports = {
  ...
  checkTempFolderSync : function(){
    var _tempFolderPath = path.join(__dirname, '../temp');
    var exists = fs.existsSync(_tempFolderPath);
    if(!exists){
      fs.mkdirSync(_tempFolderPath);
    }
    var _uniqueTempFolderPath = path.join(_tempFolderPath, (new Date()).valueOf().toString());
